...
module.exports = {
  varint: [readVarInt, writeVarInt, sizeOfVarInt, require('../../Proto/schemas/utils.json').varint],
  bool: [readBool, writeBool, 1, require('../../Proto/schemas/utils.json').bool],
  pstring: [readPString, writePString, sizeOfPString, require('../../Proto/schemas/utils.json').pstring],
  buffer: [readBuffer, writeBuffer, sizeOfBuffer, require('../../Proto/schemas/utils.json').buffer],
  void: [readVoid, writeVoid, 0, require('../../Proto/schemas/utils.json').void],
  bitfield: [readBitField, writeBitField, sizeOfBitField, require('../../Proto/schemas/utils.json').bitfield],
  cstring: [readCString, writeCString, sizeOfCString, require('../../Proto/schemas/utils.json').cstring],
  mapper: [readMapper, writeMapper, sizeOfMapper, require('../../Proto/schemas/utils.json').mapper]
}
