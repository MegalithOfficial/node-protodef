...
module.exports = {
  array: [readArray, writeArray, sizeOfArray, require('../../Proto/schemas/structures.json').array],
  count: [readCount, writeCount, sizeOfCount, require('../../Proto/schemas/structures.json').count],
  container: [readContainer, writeContainer, sizeOfContainer, require('../../Proto/schemas/structures.json').container]
}
