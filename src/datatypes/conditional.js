...
module.exports = {
  switch: [readSwitch, writeSwitch, sizeOfSwitch, require('../../Proto/schemas/conditional.json').switch],
  option: [readOption, writeOption, sizeOfOption, require('../../Proto/schemas/conditional.json').option]
}
